...
class Unet_Separate_3(Module):
    """
    相比普通U-net加入了res连接,并分离了3D卷积为3*3*1+1*1*3,最终几层宽度增加
    """
    def __init__(self, inc=1, n_classes=5, base_chns=12, droprate=0, norm='in', depth = False, dilation=1, separate_direction='axial',output_feature=False, output_distance=False):
        super(Unet_Separate_3, self).__init__()
        self.model_name = "seg"
